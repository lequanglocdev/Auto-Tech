...
//                 console.log("dịch vụ",serviceResponse)
...
//     useEffect(() => {
//         const currentDateTime = getCurrentDateTime(); // Lấy thời gian hiện tại
//         setAppointmentDatetime(currentDateTime); // Cập nhật state
//     }, []);
...
//                 slotId,
//                 selectedVehicle._id,
//                 selectedPriceServices.map((service) => service?.priceline_id), 
//                 appointmentDatetime,
//                 totalTime 
//             );
...
//     const calculateTotalTime = (selectedPriceServices) => {
//         if (!Array.isArray(selectedPriceServices)) return 0;
//         return selectedPriceServices.reduce((total, service) => total + (service.time_required || 0), 0);
      
//     };

//     const calculateTotalPrice = (selectedPriceServices) => {
//         if (!Array.isArray(selectedPriceServices)) return 0;
//         return selectedPriceServices.reduce((total, service) => total + (parseFloat(service.price) || 0), 0);
//     };
...
//     useEffect(() => {
//         const sumTime = calculateTotalTime(selectedPriceServices);
//         setTotalTime(sumTime);
//     }, [selectedPriceServices]);

//     useEffect(() => {
//         const sumPrice = calculateTotalPrice(selectedPriceServices);
...
//                                 />
//                                 <Form.Control.Feedback type="invalid">{serviceNameError}</Form.Control.Feedback>
//                             </Col>
//                             <Col xs={2}>
...
//                                             <td className={styles.dataTableItem}>{item.time_required}</td>
...
//                                         <td className={styles.dataTableItem}>{service.time_required}</td>
...
//                 <div>
//                     <h4>Tổng thời gian thực hiện: {totalTime} phút</h4>
//                     <h4>Tổng phí dịch vụ: {totalPrice} </h4>
//                 </div>
