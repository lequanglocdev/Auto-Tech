...
const EditPriceDetailModal = ({ priceId, show, onHide, onUpdate }) => {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'price') {
            ...
            if (!/^\d*\.?\d*$/.test(value) || parseFloat(value) <= 0) {
                toast.error('Giá phải là ko phải là chữ cái');
                toast.error('Giá phải phải lớn hơn 0');
                return;
            }
        }
...
export default EditPriceDetailModal;
